package com.polus.tvaddtool.ga.report;
...
public class HelloAnalyticsReporting {
	...
	private static final String APPLICATION_NAME = "TV Commercial";
	private static final JsonFactory JSON_FACTORY = JacksonFactory.getDefaultInstance();
	private static final String KEY_FILE_LOCATION = System.getProperty("user.dir") + File.separator + "client_secret.json";
	private static final String VIEW_ID = "296940825";
	...
	private static GetReportsResponse getReport(AnalyticsReporting service) throws IOException {
		...
		dateRange.setEndDate("2021-12-27");
